...
public class Template implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private gg.innit.singularity.impl.k8s.v1.gameserverspec.template.Metadata metadata;

    public gg.innit.singularity.impl.k8s.v1.gameserverspec.template.Metadata getMetadata() {
        return metadata;
    }

    public void setMetadata(gg.innit.singularity.impl.k8s.v1.gameserverspec.template.Metadata metadata) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserverspec.template.Spec spec;

    public gg.innit.singularity.impl.k8s.v1.gameserverspec.template.Spec getSpec() {
        return spec;
    }

    public void setSpec(gg.innit.singularity.impl.k8s.v1.gameserverspec.template.Spec spec) {
        this.spec = spec;
    }
}
