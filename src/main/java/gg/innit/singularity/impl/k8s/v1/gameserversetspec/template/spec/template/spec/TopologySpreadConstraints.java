...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({"labelSelector","maxSkew","minDomains","topologyKey","whenUnsatisfiable"})
...
public class TopologySpreadConstraints implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.topologyspreadconstraints.LabelSelector labelSelector;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.topologyspreadconstraints.LabelSelector getLabelSelector() {
        return labelSelector;
    }

    public void setLabelSelector(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.topologyspreadconstraints.LabelSelector labelSelector) {
