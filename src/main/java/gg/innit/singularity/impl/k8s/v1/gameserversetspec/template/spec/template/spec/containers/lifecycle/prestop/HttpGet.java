package gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.lifecycle.prestop;
...
public class HttpGet implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.lifecycle.prestop.httpget.HttpHeaders> httpHeaders;

    public java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.lifecycle.prestop.httpget.HttpHeaders> getHttpHeaders() {
        return httpHeaders;
    }

    public void setHttpHeaders(java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.lifecycle.prestop.httpget.HttpHeaders> httpHeaders) {
