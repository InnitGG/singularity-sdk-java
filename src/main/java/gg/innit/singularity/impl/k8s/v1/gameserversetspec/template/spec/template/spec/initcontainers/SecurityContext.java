package gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers;
...
public class SecurityContext implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.securitycontext.Capabilities capabilities;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.securitycontext.Capabilities getCapabilities() {
        return capabilities;
    }

    public void setCapabilities(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.securitycontext.Capabilities capabilities) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.securitycontext.SeLinuxOptions seLinuxOptions;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.securitycontext.SeLinuxOptions getSeLinuxOptions() {
        return seLinuxOptions;
    }

    public void setSeLinuxOptions(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.securitycontext.SeLinuxOptions seLinuxOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.securitycontext.SeccompProfile seccompProfile;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.securitycontext.SeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.securitycontext.SeccompProfile seccompProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.securitycontext.WindowsOptions windowsOptions;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.securitycontext.WindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.securitycontext.WindowsOptions windowsOptions) {
