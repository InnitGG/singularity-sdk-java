...
public class StartupProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.initcontainers.startupprobe.Exec exec;

    public gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.initcontainers.startupprobe.Exec getExec() {
        return exec;
    }

    public void setExec(gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.initcontainers.startupprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.initcontainers.startupprobe.Grpc grpc;

    public gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.initcontainers.startupprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.initcontainers.startupprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.initcontainers.startupprobe.HttpGet httpGet;

    public gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.initcontainers.startupprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.initcontainers.startupprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.initcontainers.startupprobe.TcpSocket tcpSocket;

    public gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.initcontainers.startupprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.initcontainers.startupprobe.TcpSocket tcpSocket) {
