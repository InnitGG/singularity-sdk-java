...
public class LivenessProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.livenessprobe.Exec exec;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.livenessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.livenessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.livenessprobe.Grpc grpc;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.livenessprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.livenessprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.livenessprobe.HttpGet httpGet;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.livenessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.livenessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.livenessprobe.TcpSocket tcpSocket;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.livenessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.initcontainers.livenessprobe.TcpSocket tcpSocket) {
