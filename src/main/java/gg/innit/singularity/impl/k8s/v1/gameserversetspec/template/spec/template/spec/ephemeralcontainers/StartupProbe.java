...
public class StartupProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.Exec exec;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.Exec getExec() {
        return exec;
    }

    public void setExec(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.Grpc grpc;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.HttpGet httpGet;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.TcpSocket tcpSocket;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.TcpSocket tcpSocket) {
