...
public class PreferredDuringSchedulingIgnoredDuringExecution implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.Preference preference;

    public gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.Preference getPreference() {
        return preference;
    }

    public void setPreference(gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.Preference preference) {
