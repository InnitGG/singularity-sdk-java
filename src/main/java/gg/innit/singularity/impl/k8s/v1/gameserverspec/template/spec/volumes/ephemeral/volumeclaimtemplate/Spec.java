package gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate;
...
public class Spec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.DataSource dataSource;

    public gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.DataSource getDataSource() {
        return dataSource;
    }

    public void setDataSource(gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.DataSource dataSource) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.DataSourceRef dataSourceRef;

    public gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.DataSourceRef getDataSourceRef() {
        return dataSourceRef;
    }

    public void setDataSourceRef(gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.DataSourceRef dataSourceRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.Resources resources;

    public gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.Resources getResources() {
        return resources;
    }

    public void setResources(gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.Selector selector;

    public gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.Selector getSelector() {
        return selector;
    }

    public void setSelector(gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.Selector selector) {
