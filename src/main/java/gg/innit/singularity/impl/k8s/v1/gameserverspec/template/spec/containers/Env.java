...
public class Env implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.containers.env.ValueFrom valueFrom;

    public gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.containers.env.ValueFrom getValueFrom() {
        return valueFrom;
    }

    public void setValueFrom(gg.innit.singularity.impl.k8s.v1.gameserverspec.template.spec.containers.env.ValueFrom valueFrom) {
