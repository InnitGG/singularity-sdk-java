...
public class Containers implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.Env> env;

    public java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.Env> getEnv() {
        return env;
    }

    public void setEnv(java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.Env> env) {
        this.env = env;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.EnvFrom> envFrom;

    public java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.EnvFrom> getEnvFrom() {
        return envFrom;
    }

    public void setEnvFrom(java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.EnvFrom> envFrom) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.Lifecycle lifecycle;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.Lifecycle getLifecycle() {
        return lifecycle;
    }

    public void setLifecycle(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.Lifecycle lifecycle) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.LivenessProbe livenessProbe;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.LivenessProbe getLivenessProbe() {
        return livenessProbe;
    }

    public void setLivenessProbe(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.LivenessProbe livenessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.Ports> ports;

    public java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.Ports> getPorts() {
        return ports;
    }

    public void setPorts(java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.Ports> ports) {
        this.ports = ports;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.ReadinessProbe readinessProbe;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.ReadinessProbe getReadinessProbe() {
        return readinessProbe;
    }

    public void setReadinessProbe(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.ReadinessProbe readinessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.Resources resources;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.Resources getResources() {
        return resources;
    }

    public void setResources(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.SecurityContext securityContext;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.SecurityContext getSecurityContext() {
        return securityContext;
    }

    public void setSecurityContext(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.SecurityContext securityContext) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.StartupProbe startupProbe;

    public gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.StartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.StartupProbe startupProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.VolumeDevices> volumeDevices;

    public java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.VolumeDevices> getVolumeDevices() {
        return volumeDevices;
    }

    public void setVolumeDevices(java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.VolumeDevices> volumeDevices) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.VolumeMounts> volumeMounts;

    public java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.VolumeMounts> getVolumeMounts() {
        return volumeMounts;
    }

    public void setVolumeMounts(java.util.List<gg.innit.singularity.impl.k8s.v1.gameserversetspec.template.spec.template.spec.containers.VolumeMounts> volumeMounts) {
