package gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.volumes.downwardapi;
...
public class Items implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.volumes.downwardapi.items.FieldRef fieldRef;

    public gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.volumes.downwardapi.items.FieldRef getFieldRef() {
        return fieldRef;
    }

    public void setFieldRef(gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.volumes.downwardapi.items.FieldRef fieldRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.volumes.downwardapi.items.ResourceFieldRef resourceFieldRef;

    public gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.volumes.downwardapi.items.ResourceFieldRef getResourceFieldRef() {
        return resourceFieldRef;
    }

    public void setResourceFieldRef(gg.innit.singularity.impl.k8s.v1.fleetspec.template.spec.template.spec.volumes.downwardapi.items.ResourceFieldRef resourceFieldRef) {
