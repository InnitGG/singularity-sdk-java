...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({"allocatedInstances","allocatedReplicas","instances","readyInstances","readyReplicas","replicas","shutdownInstances","shutdownReplicas"})
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(using = com.fasterxml.jackson.databind.JsonDeserializer.None.class)
public class GameServerSetStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("shutdownInstances")
    @javax.validation.constraints.NotNull()
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private Integer shutdownInstances;

    public Integer getShutdownInstances() {
        return shutdownInstances;
    }

    public void setShutdownInstances(Integer shutdownInstances) {
        this.shutdownInstances = shutdownInstances;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("shutdownReplicas")
    @javax.validation.constraints.NotNull()
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
